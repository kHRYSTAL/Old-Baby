 ...
 */
public class MediaIjkPlayer extends JZMediaInterface implements IMediaPlayer.OnPreparedListener, IMediaPlayer.OnVideoSizeChangedListener,
    ...
    private static final String TAG = MediaIjkPlayer.class.getSimpleName();
