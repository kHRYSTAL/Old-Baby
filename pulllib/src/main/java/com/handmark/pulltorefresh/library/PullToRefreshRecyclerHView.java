...
public class PullToRefreshRecyclerHView extends PullToRefreshBase<RecyclerView> {
    ...
    public PullToRefreshRecyclerHView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PullToRefreshRecyclerHView(Context context, Mode mode) {
        super(context, mode);
    }

    public PullToRefreshRecyclerHView(Context context, Mode mode, AnimationStyle style) {
    ...
    private boolean isFirstItemVisible() {
        ...
        if (null == adapter || adapter.getItemCount() == 0) {
            ...
            if (getFirstVisiblePosition() == 0) {
                return mRefreshableView.getChildAt(0).getLeft() >= mRefreshableView.getLeft();
            }
        }
