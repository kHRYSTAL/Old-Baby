package com.oldbaby.oblib.view.title;
...
/**
 * usage: app 统一标题 支持标题左右增加 隐藏button按钮 按钮点击事件
 * <p>
 * addRightTitleButton(), addLeftTitleButton(), hideTitleButton() onTitleClicked()
 * </p>
 * author: kHRYSTAL
 * create time: 18/9/21
 * update time:
...
public class TitleBar implements View.OnClickListener {
    ...
    public TitleBar(final View view, final OnTitleClickListener titleListener) {
        ...
        this.titleLayout = this.root.findViewById(R.id.custom_title);
        this.init();
    }
    ...
    public void removeRightButtons() {
        ...
        MLog.d(TAG, "remove right container view");
    }
